...
*Fecha:* ${formData.date}
*Hora:* ${formData.timeLabel}
*Lugar:* ${formData.addressLabel}
*Link Maps:* ${formData.mapEmbed}
*Fecha Contador:* ${formData.countdownDate}
*WhatsApp Confirmación:* ${formData.whatsappNumber}
*Puntos Juego:* ${formData.targetScore}
